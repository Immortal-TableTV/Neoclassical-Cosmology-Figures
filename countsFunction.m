%% Figure 13.8
% Counts as a function of redshift
%
% F_n(z) = [H0a0r(z)]^2 / (1+z)^2
%
...
% Redshift Values
zvals = linspace(0.0001, 10, 300);     % Avoid z = 0 in case our function is undefined at that point
...
if choice == 1
    title('Counts as a Function of Redshift: Flat Models')
elseif choice == 2
    title('Counts as a Function of Redshift: No Dark Energy Models')
end
